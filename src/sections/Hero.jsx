      ...
      >
        ...
        <span className='text-white drop-shadow-[0_0_6px_rgba(100,200,255,0.8)]'>
          {word.text}
              ...
              <motion.h1 custom={1} variants={lineVariant}>into Interactive</motion.h1>
              <motion.h1 custom={2} variants={lineVariant}>Seamless Experiences</motion.h1>
            </div>
            ...
            >
              Hey there! I’m Sujal Bhagat — a modern web developer turning ideas <br />
